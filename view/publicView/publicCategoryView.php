...
<head>
    ...
    <title>DB - BDD : <?=$categ['title']?></title>
    <!-- Favicon-->
...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-8">
            ...
            if(empty($nbPost)):
                ?>
                <h2 class="fw-bolder mb-1">Pas encore de message dans la catégorie <?=$categ['title']?></h2>
            <?php
            else:
                ?>
                <h2 class="fw-bolder mb-1">Nous avons <?=$nbPost?> article(s) dans la catégorie <?=$categ['title']?></h2>
                <?php
