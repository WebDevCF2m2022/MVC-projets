...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 19 fév. 2023 à 11:08
...
VALUES (1, ''BDD SQL'',
        ''SQL (sigle de Structured Query Language, en français langage de requête structurée) est un langage informatique normalisé servant à exploiter des bases de données relationnelles. La partie langage de manipulation des données de SQL permet de rechercher,
        d\'' ajouter, de modifier ou de supprimer des données dans les bases de données relationnelles.''),
       (2, ''BDD NoSQL'', ''En informatique et en bases de données,
       ...
       (4, ''Conception de BDD'',
        ''La conception de base de données est l\''organisation des données selon un modèle de base de données . Le concepteur détermine quelles données doivent être stockées et comment les éléments de données sont interdépendants. Avec ces informations,
        ils peuvent commencer à adapter les données au modèle de base de données.''),
...
INSERT INTO `category_has_post` (`category_id`, `post_id`)
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
...
INSERT INTO `post` (`id`, `title`, `content`, `datecreate`, `visible`, `user_id`)
VALUES (1, ''MySQL'',
        ...
        en concurrence avec Oracle,
        PostgreSQL et Microsoft SQL Server.\n\nSon nom vient du prénom de la fille du co créateur Michael Widenius: My. \n\nSQL fait référence au Structured Query Language,
        le langage de requête utilisé.\n\nMySQL AB a été acheté le 16 janvier 2008 par Sun Microsystems pour un milliard de dollars américains. En 2009,
        Sun Microsystems a été acquis par Oracle Corporation,
        mettant entre les mains d\''une même société les deux produits concurrents que sont Oracle Database et MySQL. Ce rachat a été autorisé par la Commission européenne le 21 janvier 2010.\n\nDepuis mai 2009,
        son créateur Michael Widenius a créé MariaDB (Maria est le prénom de sa deuxième fille) pour continuer son développement en tant que projet Open Source.\n\nMySQL est un serveur de bases de données relationnelles SQL développé dans un souci de performances élevées en lecture,
        ce qui signifie qu\''il est davantage orienté vers le service de données déjà en place que vers celui de mises à jour fréquentes et fortement sécurisées. Il est multi-thread et multi-utilisateur.\n\nC\''est un logiciel libre,
        open source,
        développé sous double licence selon qu\''il est distribué avec un produit libre ou avec un produit propriétaire. Dans ce dernier cas,
        la licence est payante,
        sinon c\''est la licence publique générale GNU (GPL) qui s\''applique. Un logiciel qui intègre du code MySQL ou intègre MySQL lors de son installation devra donc être libre ou acquérir une licence payante. Cependant,
        si la base de données est séparée du logiciel propriétaire qui ne fait qu\''utiliser des API tierces (par exemple en C# ou php), alors il n\''y a pas besoin d\''acquérir une licence payante MySQL. Ce type de licence double est utilisé par d\''autres produits comme le framework de développement de logiciels Qt (pour les versions antérieures à la 4.5).\n\nWikipédia : https://fr.wikipedia.org/wiki/MySQL'', ''2023-02-10 10:43:08'', 1, 1),
